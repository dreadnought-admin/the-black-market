    ...
    _createClass(SpotifyWebPlayer, [
        ...
        },
        {
            ...
            value: function componentDidUpdate(previousProps, previousState) {
                var _this = this;
                return _asyncToGenerator(function() {
                    var _this_state, currentDeviceId, deviceId, errorType, isInitializing, isPlaying, status, track, _this_props, autoPlay, offset, playProp, showSaveIcon, syncExternalDevice, token, uris, isReady, changedURIs, playOptions, canPlay, shouldPlay, player;
                    return __generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                _this_props = _this.props, autoPlay = _this_props.autoPlay, offset = _this_props.offset, playProp = _this_props.play, showSaveIcon = _this_props.showSaveIcon, syncExternalDevice = _this_props.syncExternalDevice, token = _this_props.token, uris = _this_props.uris;
